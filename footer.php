	...
	<nav id="mainNav">
		...
		<a href="<?php echo home_url(); ?>" class="logo_sm">TEDxGCT</a>
	
    	<?php wp_nav_menu(array('theme_location' => 'primary_navigation', 'depth' => 1)); ?>
		
		<ul class="clearfix">
			<li><a href="http://twitter.com/#!/tedxgct/">Twitter</a></li>
			<li><a href="http://www.facebook.com/TEDxGCT">Facebook</a></li>
	...
	<footer class="row">
		...
		<section class="recentTweet three columns clearfix">
			...
			<span style="float:right;">TEDxGCT on <a href="http://twitter.com/tedxgct/">Twitter.com</a></span>
		...
		<section class="legalStuff three columns clearfix">
			...
			© 2012 TEDxGCT. All rights reserved.</p>
		</section>
