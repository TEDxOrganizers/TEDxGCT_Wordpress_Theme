...
add_action( 'after_setup_theme', 'tedxgct_setup' );

// Custom Sidebar
// http://codex.wordpress.org/Function_Reference/register_sidebar

function tedxgct_register_sidebars() {
...
add_action('widgets_init', 'tedxgct_register_sidebars');
...
// Add TEDxGCT logo and redirect link
...
function custom_menu_order($menu_ord){
	...
	return array(
		'index.php',
		'edit.php',
		'edit.php?post_type=tedxgct_speaker',
		'edit.php?post_type=tedxgct_committee',
...
function create_year_taxonomy() {
	$labels_year = array(
  	...
  	register_taxonomy('tedxgctYear','speakers',array(
    	'hierarchical' => false,
    	'labels' => $labels_year,
...
function create_category_taxonomy() {
	$labels_category = array(
  	...
  	register_taxonomy('tedxgctCategory','sponsors',array(
    	'hierarchical' => false,
